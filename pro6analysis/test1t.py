...
teacher1 = [71, 58, 92, 78, 71, 68, 67, 88, 88, 60, 80, 70, 68, 82, 78]
teacher2 = [50, 65, 75, 91, 67, 39, 81, 68, 97, 86, 66, 60, 65, 55, 58]

# 두 개의 표본에 대한 '독립 표본 t-검정' 수행
two_sample = stats.ttest_ind(teacher1,teacher2)
print(two_sample)
